...
const ConsultationForm: React.FC<ConsultationFormProps> = ({ isOpen, onClose }) => {
  ...
  const handleWhatsApp = () => {
    window.open(`https://wa.me/254795704273?text=Hi, I'm interested in ${formData.service || 'your services'}. My name is ${formData.name || '[Your Name]'}.`, '_blank');
  };
  ...
  const handleCall = () => {
    window.location.href = 'tel:+254795704273';
  };
